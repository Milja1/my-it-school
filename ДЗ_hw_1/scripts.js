...
let width = 10,
	height = 23,
	SPryam = width * height;
document.write('S = ' + SPryam + ' cm square' + '<br/>');

let diameter = a7,
	VCilindra = height * diameter;
document.write('V = ' + VCilindra + ' cm cubic' + '<br/>');

let radius = 5,
	SKruga = radius * Math.PI;
document.write('S = ' + SKruga + ' cm square' + '<br/>');

let base1 = 5,
	base2 = 7,
	h = 10,
	STrap = (base1 + base2) / 2 * h;
document.write('S = ' + STrap + ' cm square' + '<br/>');

let S = 2000000,
	p = 10,
	years = 5,
	Pereplata = (S * p) / 100 * years;
document.write('Pereplata = ' + Pereplata + ' руб.' + '<br/>');
